package com.webbiko.pontointeligente.api.controllers;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.webbiko.pontointeligente.api.BaseTest;
import com.webbiko.pontointeligente.api.dtos.LancamentoDto;
...
import com.webbiko.pontointeligente.api.services.LancamentoService;
...
public class LancamentoControllerTest extends BaseTest {
    @Autowired
    private MockMvc mvc;
    ...
    private static final String TIPO = LancamentoType.INICIO_TRABALHO.name();
...
//    @WithMockUser
    ...
    private Lancamento obterDadosLancamento() {
        ...
        lancamento.setTipo(LancamentoType.valueOf(TIPO));

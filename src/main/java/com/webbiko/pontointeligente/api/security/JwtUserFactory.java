package com.webbiko.pontointeligente.api.security;
...
public class JwtUserFactory {
    ...
    public static JwtUser create(Funcionario funcionario) {
        return new JwtUser(funcionario.getId(), funcionario.getEmail(), funcionario.getSenha(),
                mapToGrantedAuthorities(funcionario.getProfile()));
    }
     ...
     */
    private static List<GrantedAuthority> mapToGrantedAuthorities(ProfileType perfilEnum) {
